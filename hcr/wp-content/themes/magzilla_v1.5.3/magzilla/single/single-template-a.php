...
rcel.src = "http://trends.revcontent.com/serve.js.php?w=24479&t="+rcel.id+"&c="+(new Date()).getTime()+"&width="+(window.outerWidth || document.documentElement.clientWidth);
rcel.async = true;
var rcds = document.getElementById("rcjsload_4eb396"); rcds.appendChild(rcel);
})();
},000);
</script>
